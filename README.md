...
## TODO 
+ I'm working on porting my systems to nix, but that's a fairly lengthy project and don't expect to be finished anytime soon.
+ I want to put my more active git repos in submodules so that commit history stays separate (really just emacs lol)
